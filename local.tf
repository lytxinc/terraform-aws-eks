locals {
  ...
  default_ami_id_windows = local.workers_group_defaults.ami_id_windows #coalesce(local.workers_group_defaults.ami_id_windows, data.aws_ami.eks_worker_windows.id)
